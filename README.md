...
1. When an edited resource form is submitted, the resource should be updated in the database and the user should be brought to that existing resource's Show view.
